...
// select all users
$stmt = $pdo->query("SELECT * FROM productnaam");
...
$product_code = 1;
$stmt = $pdo->prepare("SELECT * FROM productnaam WHERE  product_code=?");
...
$product_code = 1;
$stmt=$pdo->prepare("SELECT * FROM productnaam where product_code=:product_code");
